  # Generated by Powerlevel10k configuration wizard on 2022-04-21 at 16:45 +0430.
  ...
  () {
    ...
    typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=85
    ...
    typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=99
    ...
    typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='fuck '''$'\ue62a'
